...
| Fri | Completed and published a World of Tanks audio mod built with Wwise: <br> &emsp; + Finalized sound banks and configuration following the modding guides. <br> &emsp; + Tested the mod in-game to ensure sounds loaded and played correctly. <br> &emsp; + Published the finished mod on the official WGMods portal: [Released mod](https://wgmods.net/7398/). | 14/11/2025 | 14/11/2025 | - |
...
* Completed and released a World of Tanks audio mod using Wwise, including in-game testing and publishing on WGMods.
