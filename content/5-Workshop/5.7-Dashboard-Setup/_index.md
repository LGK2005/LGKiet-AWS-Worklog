...
This guide will show you how to setup the dashboard. The dashboard will be using S3 to contain the web files and folder, Lambda to query data using Athena, API Gateway
